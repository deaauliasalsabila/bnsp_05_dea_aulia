		...
		<div class="sidebar-layout">
			...
			<div class="s-layout-sidebar">
				<a class="s-sidebar-trigger" href="#">
					...
					<i class="fa fa-user" style="float: right; margin-right: 30px;"><span class="span-user">Kasir</span></i>
					
				</a>

				<div class="s-sidebar-nav">
					<ul>
						<li><a class="s-sidebar-nav-link" href="<?php echo base_url(). 'kasir' ?>"><i class="fa fa-home"></i><em>Dashboard</em></a></li>
						<li><a class="s-sidebar-nav-link" href="<?php echo base_url(). 'kasir/v_all_dataPelanggan' ?>"><i class="fa fa-users"></i><em>Data Pelanggan</em></a></li>
						<li><a class="s-sidebar-nav-link" href="<?php echo base_url(). 'kasir/profil/' ?><?php echo $row->id_user ?>"><i class="fa fa-user"></i><em>Profil</em></a></li>
						<li><a class="s-sidebar-nav-link" href="<?php echo base_url(). 'kasir/v_all_dataTransaksi' ?>"><i class="icon-file-alt"></i><em>Data Transaksi</em></a></li>
						<li><a class="s-sidebar-nav-link" href="<?php echo base_url(). 'kasir/v_all_dataLaporan' ?>"><i class="icon-folder-open-alt"></i><em>Laporan</em></a></li>
