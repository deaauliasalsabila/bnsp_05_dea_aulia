	...
	<body>
		...
		<div class="container-fluid jarakbawah">
			<div class="judul tkiri" style="font-size: 70px; margin: 4%;">
				<center><span style="color: #090b16;"> pesan</span> makanan</center>
			</div>

			<form action="<?php echo base_url() ?>index.php/waiter/addorder" method="post">
				<P style="padding: 5px; width: 100%;" class="jarakanan bbiru putihtua">ISI FORM</P>
				<div style="margin: 2%;">
					<input type="text" name="id_order" value="<?php echo $idorder; ?>" hidden>
					<center><span class="formpesan jarakiri">No. Meja <select style="width: 8%;" name="nomeja">
						<option>01</option>
						<option>02</option>
						<option>03</option>
						<option>04</option>
						...
						<option>10</option>
						<option>11</option>
					</select></span> <span class="formpesan jarakiri">Tanggal <input type="text" name="tanggal" value="<?php echo tanggal(); ?>" style="width: 15%;" READONLY></span>
				</center>

			</div><br>
			<P style="padding: 5px; width: 100%;" class="jarakanan bbiru putihtua">DETAIL MAKANAN</P>
			<br>
			<button style="border-radius: 6px; background-color: #090b16; width: 10%;"><a href="<?php echo base_url().'index.php/waiter/menu2' ?>" style="color: white;">MENU</a></button>
			<div class="kotak">
				
				<div style="overflow-x:auto; width: 100%; height: 300px; overflow-x: auto;"> 
					<?php echo form_open('index.php/waiter/cekcart'); ?>
					...
					<table>
						...
						<?php foreach ($this->cart->contents() as $items): ?>
							...
							<tr>
								<td><?php echo anchor('index.php/waiter/removecart/'.$items['rowid'], 'Hapus') ?></td>
		...
		<br>
		<div class="formpesan"><span class="jarakiri"><input type="submit" name="tambah" value="PESAN"></span><!-- <?php echo form_submit('', 'CEK HARGA'); ?> --></div>
		</div>
